    ...
    <div className="h-full flex-col justify-between  bg-white hidden lg:flex">
      <div className="px-6 py-6">
        <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-5">
          <Link
            to="/"
            className="flex items-center gap-2 rounded-lg hover:bg-gray-100 px-4 py-4 text-gray-700"
          >
            <img
              alt="dashboard-icon"
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-4 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/inventory">
          ...
          <Link
            to="/purchase-details"
            className="flex items-center gap-2 rounded-lg px-4 py-4 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
          >
            <img
              alt="purchase-icon"
